...
<body class="bg-light">
    ...
    <div class="container">
        <div class="row">
            ...
            while ($room_data = mysqli_fetch_assoc($room_res)) {
                ...
                //get thimbnail of image

                $room_thumb = ROOMS_IMG_PATH . "thumbnaill.jpg";
    ...
    <!-- Facilities-->
    <h2 class="mt-5 pt-4 text-center fw-bold h-font">FACILITIES</h2>
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-4">
                ...
                <div class="bg-white p=4 rounded mb-4">
                    ...
                    if ($contact_r['fb'] != '') {
                        echo <<<data
                            <a href="$contact_r[fb]" class="d-line-block text-dark text-decoration-none mb-2">
                    ...
                    ?>
                    <a href="<?php echo $contact_r['ln'] ?>" class="d-line-block text-dark text-decoration-none mb-2">
