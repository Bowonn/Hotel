        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <div class="d-flex">
                ...
                if (isset($_SESSION['login']) && $_SESSION['login'] == true) {
                    ...
                    echo <<<data
                        <div class="btn-group">
                            <button type="button" class="btn btn-outline-dark shadown-none dropdown-toggle" data-bs-toggle="dropdown" data-bs-display="static" aria-expanded="false">
            ...
            <form id="forgot-form">
                ...
                <div class="modal-body">
                    <span class="badge rounded-pill bg-light text-dark mb-3 text-wrap lh-base">
                        Note: A link will be sent to your enail to reset ypur password!
                    </span>
                    <div class="mb-4">
