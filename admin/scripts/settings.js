...
function get_contacts() {
    ...
    let contacts_p_id = ['address', 'gmap', 'pn1', 'pn2', 'email', 'fb', 'ln'];
...
function contacts_inp(data) {
    let contacts_inp_id = ['address_inp', 'gmap_inp', 'pn1_inp', 'pn2_inp', 'email_inp', 'fb_inp', 'ln_inp', 'iframe_inp'];
...
function upd_contacts() {
    let index = ['address', 'gmap', 'pn1', 'pn2', 'email', 'fb', 'ln', 'iframe'];
    let contacts_inp_id = ['address_inp', 'gmap_inp', 'pn1_inp', 'pn2_inp', 'email_inp', 'fb_inp', 'ln_inp', 'iframe_inp'];
...
function add_member() {
    ...
    xhr.onerror = function() {
        alert('error', 'An error occurred while adding a member.');
    };
