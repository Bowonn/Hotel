            ...
            <div class="col-lg-10 ms-auto p-4 over-flow-hidden">
                ...
                <div class="card border-0 shadow-sm mb-4">
                    <div class="card-body">
                        ...
                        <p class="card-text">
                            No customers will be allowed to book hotel room, when Shutdown mode is turnde on.
                        </p>
                    </div>
                </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <div class="input-group mb-3">
                                                        <span class="input-group-text" id="basic-addon1"><i class="bi bi-facebook"></i></i></span>
                                                        <input type="text" name="fb" id="fb_inp" class="form-control shadow-none" require>
                                                    </div>
                                                    <div class="input-group mb-3">
                                                        <span class="input-group-text" id="basic-addon1"><i class="bi bi-line"></i></i></span>
                                                        <input type="text" name="ln" id="ln_inp" class="form-control shadow-none" require>
                                                    </div>
                                                </div>
                                                <div class="mb-3">
