...
define('SENDGRID_EMAIL', 'your_sendgrid_email@example.com');
define('SENDGRID_NAME', 'Your Name or Company');
...
if (isset($_POST['register'])) {
    ...
    $query = "INSERT INTO `user_cred`(`name`, `email`, `phonenum`, `pincode`, `profile`, `dob`,
     `password`, `token`) VALUES (?,?,?,?,?,?,?,?)";

    $values = [$data['name'], $data['email'], $data['phonenum'], $data['pincode'], $img, $data['dob'], $enc_pass, $token];
